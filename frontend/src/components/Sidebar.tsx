    ...
    <div className="w-64 border-r border-[rgb(var(--border))] bg-[rgb(var(--surface))] flex flex-col h-screen">
      <div className="p-6 border-b border-[rgb(var(--border))]">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-nova-400 to-cyan-400 rounded-2xl flex items-center justify-center">
          ...
          return (
            <Link
              ...
              className={`group flex items-center gap-3 px-4 py-3 rounded-2xl font-medium transition-all ${
                isActive
                  ? 'bg-[rgb(var(--surface-2))] text-white shadow-md'
                  : 'text-[rgb(var(--text-secondary))] hover:bg-[rgb(var(--surface-2))] hover:text-white'
              }`}
            >
