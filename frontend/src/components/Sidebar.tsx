...
import { Home, Bot, Command, BarChart3, Shield, Zap, Music, Server, BookOpen, Settings } from 'lucide-react';
          ...
          return (
            <Link
              ...
              className={`group flex items-center gap-3 px-4 py-3 rounded-2xl font-medium transition-all ${
                isActive ? 'bg-[rgb(var(--surface-2))] text-white shadow-sm' : 'text-[rgb(var(--text-secondary))] hover:bg-[rgb(var(--surface-2))] hover:text-[rgb(var(--text))]'
              }`}
            >
