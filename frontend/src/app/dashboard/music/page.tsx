        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ background: '#16161F', borderRadius: '14px', padding: '20px 24px', border: '1px solid #1F2937' }}>
            ...
            {[
              ...
              { label: 'Автоотключение (мин)', key: 'autoDisconnect', min: 5, max: 120, step: 5, suffix: '' },
          ...
          <div style={{ background: '#16161F', borderRadius: '14px', padding: '20px 24px', border: '1px solid #1F2937' }}>
            ...
            {[
              { key: 'autoPlay', label: 'Автовоспроизведение', desc: 'Следующий трек автоматически' },
            ...
            {settings.djOnly && (
              <div style={{ marginTop: '12px' }}>
                ...
                <input type="text" value={settings.djRole} onChange={(e) => update('djRole', e.target.value)} style={{ width: '100%', padding: '10px 14px', background: '#0A0A0F', border: '1px solid #1F2937', borderRadius: '10px', color: '#FFF', fontSize: '14px', outline: 'none', boxSizing: 'border-box' }} />
              </div>
            )}
          </div>
        </div>
