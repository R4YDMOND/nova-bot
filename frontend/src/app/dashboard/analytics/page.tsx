        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <div style={{ background: '#16161F', borderRadius: '14px', padding: '20px 24px', border: '1px solid #1F2937' }}>
            ...
            <div style={{ marginBottom: '12px' }}>
              ...
              <input type="text" value={sanitize(settings.reportChannel)} onChange={(e) => update('reportChannel', e.target.value)}
            ...
            {[
              { label: '🗄️ Хранение данных (дней)', key: 'retentionDays', min: 7, max: 90, step: 7 },
