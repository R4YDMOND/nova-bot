...
def auth_vk():
    ...
    state = secrets.token_hex(16)
    url = f"https://id.vk.com/oauth2/auth?client_id={app_id}&redirect_uri={redirect_uri}&response_type=code&scope=email&state={state}&code_challenge={state}&code_challenge_method=s256"
    return {"url": url, "state": state}
